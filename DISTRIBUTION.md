...
pulls a statically linked ONNX Runtime in through `v4nano-embed`, and cross-builds of that are what
...
1. **One package carrying all four platform libraries.** Simplest possible
   ...
   autoembedding pulls `v4nano-embed` (and ONNX Runtime) into every binary).
