...
|----------|----------|-----------|:-----:|:-------:|
| **Python** | PyO3 native (or pure-Python) | `bindings/python/` | ✅ | — |
| **C** | `extern "C"` from Rust | `bindings/c/` | 62 | `example.c` |
| **C++** | RAII wrapper over C API | `bindings/c/include/moofile.hpp` | 39 | (inline) |
| **Node.js** | `koffi` FFI (pure JS) | `bindings/node/` | 18 | `example.js` |
| **Go** | cgo + C header | `bindings/go/` | 14 | `example/main.go` |
| **Java** | JNR-FFI | `bindings/java/` | 📝 | `Example.java` |
| **C#** | P/Invoke | `bindings/csharp/` | 12 | `MoofileExample/` |
